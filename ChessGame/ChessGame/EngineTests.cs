...
public class EngineTests
{
    public static void RunTest()
    {
        ...
        gameRenderer.AssignCheckersPattern(map, ConsoleColor.White, ConsoleColor.Black, ConsoleColor.Gray);
        
        var renderer1 = new ConsoleTileRenderer();
        var consoleString1 = new ConsoleDrawableString("$", ConsoleColor.Yellow, ConsoleColor.DarkCyan);
        ...
        var consoleString2 = new ConsoleDrawableString("#", ConsoleColor.Red, ConsoleColor.Magenta);
        ...
        var consoleString3 = new ConsoleDrawableString("%", ConsoleColor.Green, ConsoleColor.DarkGray);
