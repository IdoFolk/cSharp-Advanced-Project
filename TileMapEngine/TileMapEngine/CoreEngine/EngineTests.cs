...
public class EngineTests
{
    public static void RunTest()
    {
        ...
        var consoleString1 = new ConsoleStringDrawableObject("$", ConsoleColor.Yellow);
        ...
        var consoleString2 = new ConsoleStringDrawableObject("#", ConsoleColor.Red);
        ...
        var consoleString3 = new ConsoleStringDrawableObject("&", ConsoleColor.Green);
        ...
        for (int i = 0; i < map.Tiles.GetLength(0); i++)
        {
            for (int j = 0; j < map.Tiles.GetLength(1); j++)
            {
                ...
                {
                    map[j,i].TileRenderer.Draw();
                }
                else
                {
                    map[j,i].CurrentTileObject.TileRenderer.Draw();
                }
            }
